...
# Usage: bash run_stella.sh [dataset] [start_idx] [end_idx]
...
echo "Output: ${OUTPUT_DIR}/${DATASET}_stella.jsonl"
echo "=================================================="

python src/inference/run_inference.py \
    --dataset "${DATA_PATH}" \
    --output "${OUTPUT_DIR}/${DATASET}_stella.jsonl" \
    --retriever stella \
...
echo "Results: ${OUTPUT_DIR}/${DATASET}_stella.jsonl"
